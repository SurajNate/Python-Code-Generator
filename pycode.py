...
"}")
        ...
        self.generate.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon = QIcon()
        icon.addFile(u":/icons/icon/1.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.horizontalSpacer_2 = QSpacerItem(756, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icon/chrome-minimize.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/icon/chrome-maximize.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon2.addFile(u":/icons/icon/chrome-restore.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/icon/chrome-close.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
